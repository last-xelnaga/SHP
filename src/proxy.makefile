...
# main
$(OBJDIR)/proxy_command.o: proxy_main.hpp message.hpp socket_server.hpp debug.hpp error_codes.hpp proxy.makefile
...
$(OBJDIR)/proxy_register.o: proxy_main.hpp message.hpp socket_server.hpp debug.hpp error_codes.hpp proxy.makefile
...
$(OBJDIR)/socket_client.o: socket_client.hpp socket.hpp message.hpp debug.hpp error_codes.hpp proxy.makefile
